    ...
    <Stack spacing={3}>
      <div>
        ...
        <Typography color="text.secondary">
          Preferências e manutenção dos cadastros locais.
        </Typography>
      </div>
      ...
      <Paper sx={{ p: 3, maxWidth: 680 }}>
        ...
        <Typography color="text.secondary" sx={{ mb: 3 }}>
          Os cadastros são armazenados neste navegador. Limpar os dados remove
          todos os registros persistidos.
        </Typography>
        <Button
          color="error"
          variant="outlined"
      ...
      >
        ...
        <DialogContent>
          Todos os clientes armazenados localmente serão removidos.
        </DialogContent>
        <DialogActions>
